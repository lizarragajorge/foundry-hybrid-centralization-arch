...
5. **Demo app hosting** — Deploy to Azure App Service via `deployDemoApp=true` + `scripts/deploy-app.ps1`; the system-assigned MI is auto-selected by `DefaultAzureCredential` (no code change needed)
